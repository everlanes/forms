...
class ApiV2Test extends TestCase {
	...
	public function testGetForms(array $expected): void {
		$resp = $this->http->request('GET', 'api/v1.1/forms');
	...
	public function testGetSharedForms(array $expected): void {
		$resp = $this->http->request('GET', 'api/v1.1/shared_forms');
	...
	public function testGetNewForm(array $expected): void {
		$resp = $this->http->request('POST', 'api/v1.1/form');
		$data = $this->OcsResponse2Data($resp);
	...
	public function testGetFullForm(array $expected): void {
		$resp = $this->http->request('GET', "api/v1.1/form/{$this->testForms[0]['id']}");
		$data = $this->OcsResponse2Data($resp);
	...
	public function testCloneForm(array $expected): void {
		$resp = $this->http->request('POST', "api/v1.1/form/clone/{$this->testForms[0]['id']}");
		$data = $this->OcsResponse2Data($resp);
	...
	public function testUpdateFormProperties(array $expected): void {
		$resp = $this->http->request('POST', 'api/v1.1/form/update', [
			'json' => [
	...
	public function testDeleteForm() {
		$resp = $this->http->request('DELETE', "api/v1.1/form/{$this->testForms[0]['id']}");
		$data = $this->OcsResponse2Data($resp);
		...
		try {
			$this->http->request('GET', "api/v1.1/form/{$this->testForms[0]['id']}");
	...
	public function testCreateNewQuestion(array $expected): void {
		$resp = $this->http->request('POST', 'api/v1.1/question', [
			'json' => [
	...
	public function testUpdateQuestionProperties(array $fullFormExpected): void {
		$resp = $this->http->request('POST', 'api/v1.1/question/update', [
			'json' => [
	...
	public function testReorderQuestions(array $fullFormExpected): void {
		$resp = $this->http->request('POST', 'api/v1.1/question/reorder', [
			'json' => [
				'formId' => $this->testForms[0]['id'],
				'newOrder' => [
	...
	public function testDeleteQuestion(array $fullFormExpected) {
		$resp = $this->http->request('DELETE', "api/v1.1/question/{$this->testForms[0]['questions'][0]['id']}");
		$data = $this->OcsResponse2Data($resp);
	...
	public function testCreateNewOption(array $expected): void {
		$resp = $this->http->request('POST', 'api/v1.1/option', [
			'json' => [
	...
	public function testUpdateOptionProperties(array $fullFormExpected): void {
		$resp = $this->http->request('POST', 'api/v1.1/option/update', [
			'json' => [
	...
	public function testDeleteOption(array $fullFormExpected) {
		$resp = $this->http->request('DELETE', "api/v1.1/option/{$this->testForms[0]['questions'][1]['options'][0]['id']}");
		$data = $this->OcsResponse2Data($resp);
	...
	public function testGetSubmissions(array $expected) {
		$resp = $this->http->request('GET', "api/v1.1/submissions/{$this->testForms[0]['hash']}");
		$data = $this->OcsResponse2Data($resp);
	...
	public function testExportSubmissions(string $expected) {
		$resp = $this->http->request('GET', "api/v1.1/submissions/export/{$this->testForms[0]['hash']}");
	...
	public function testExportToCloud() {
		$resp = $this->http->request('POST', 'api/v1.1/submissions/export', [
			'json' => [
	...
	public function testDeleteSubmissions(array $submissionsExpected) {
		$resp = $this->http->request('DELETE', "api/v1.1/submissions/{$this->testForms[0]['id']}");
		$data = $this->OcsResponse2Data($resp);
	...
	public function testInsertSubmission(array $submissionsExpected) {
		$resp = $this->http->request('POST', 'api/v1.1/submission/insert', [
			'json' => [
				'formId' => $this->testForms[0]['id'],
				'answers' => [
	...
	public function testDeleteSingleSubmission(array $submissionsExpected) {
		$resp = $this->http->request('DELETE', "api/v1.1/submission/{$this->testForms[0]['submissions'][0]['id']}");
		$data = $this->OcsResponse2Data($resp);
